...
# Form implementation generated from reading ui file 'C:\Users\mico\sandbox\pingme\pingme.ui'
#
# Created: Tue Aug 31 15:48:40 2010
...
if __name__ == "__main__":
    ...
    PingMainWindow = QtGui.QMainWindow()
    ui = Ui_PingMainWindow()
    ui.setupUi(PingMainWindow)
    PingMainWindow.show()
    sys.exit(app.exec_())
